			...
			enum led_brightness value)
{
	...
	/* The 888 platform uses dual-LED design. */
	/* When hal delivers a current value of 1 or 2, the kernel actually sets the code to 0 */
	if (value > 0 && value < LOWEST_CURRENT_LEVEL)
		value = LOWEST_CURRENT_LEVEL;
