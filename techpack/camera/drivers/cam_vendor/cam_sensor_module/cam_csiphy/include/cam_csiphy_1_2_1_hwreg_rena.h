 ...
 *
 * Description: vendor csiphy reg list
 */

#ifndef _CAM_CSIPHY_1_2_1_HWREG_RENA_H_
#define _CAM_CSIPHY_1_2_1_HWREG_RENA_H_

#include "cam_csiphy_dev.h"

struct csiphy_reg_parms_t csiphy_reg_rena = {
...
struct csiphy_reg_t csiphy_common_reg_rena[] = {
...
struct csiphy_reg_t csiphy_reset_reg_rena[] = {
...
struct csiphy_reg_t csiphy_irq_reg_rena[] = {
...
struct
csiphy_reg_t csiphy_2ph_reg_rena[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
...
struct csiphy_reg_t
	csiphy_2ph_combo_mode_reg_rena[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0030, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0900, 0x05, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0908, 0x10, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct
csiphy_reg_t csiphy_3ph_reg_rena[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
...
struct data_rate_settings_t data_rate_delta_table_rena_default = {
...
struct data_rate_settings_t data_rate_delta_table_rena_phy0 = {
	.num_data_rate_settings = 3,
	.data_rate_settings = {
		{
			/* (2.5 * 10**3 * 2.28) rounded value */
...
#endif /* _CAM_CSIPHY_1_2_1_HWREG_RENA_H_ */
